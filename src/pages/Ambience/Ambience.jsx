  ...
  return (
   <Box sx={{ py:10 }}>
    <Container>
        <CustomBox>
            <ImgContainer>
            <img src={houseCard} alt='house' style={{maxWidth: '80%'}} />
            </ImgContainer>
            <Box>
                <Divider/>
                <Typography
                ...
                >
                    Discover The Epitome Of Culinary Excellence At Savoria, Where Every Visit Is An Enchanting Rendezvous With Thw Art Of Dining.
                </Typography>
            </Box>
        </CustomBox>
        ...
        <TextFlexBox>
            ...
            >
                ...
                <SmallText>Delevery Per Day</SmallText>
            </Box>
        </TextFlexBox>
    </Container>
   </Box>
