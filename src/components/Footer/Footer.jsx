   ...
   <Box sx={{ py: 10, backgroundColor: "#FFF6B2"}}>
    <CustomContainer>
        ...
        <Typography
          ...
          <Link To='/services'>  <FooterLink >Location</FooterLink><br /></Link>
            <FooterLink>Partnerships</FooterLink><br />
            <FooterLink>Terms of use & Privacy Policy</FooterLink>
        </Box>
        <Box>
        <Typography
            sx={{
            ...
            <IconBox>
                ...
                <img src={instaIcon} alt='LinkedIcon' style={{ cursor: "pointer"}} />
            </IconBox>
